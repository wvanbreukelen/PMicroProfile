cmd_arch/x86/boot/compressed/kaslr_64.o := gcc -Wp,-MD,arch/x86/boot/compressed/.kaslr_64.o.d -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/11/include -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -m64 -O2 -fno-strict-aliasing -fPIE -DDISABLE_BRANCH_PROFILING -mcmodel=small -mno-mmx -mno-sse -ffreestanding -fno-stack-protector -Wno-address-of-packed-member -Wno-pointer-sign -Wa,-mrelax-relocations=no    -DKBUILD_BASENAME='"kaslr_64"' -DKBUILD_MODNAME='"kaslr_64"' -c -o arch/x86/boot/compressed/kaslr_64.o arch/x86/boot/compressed/kaslr_64.c

source_arch/x86/boot/compressed/kaslr_64.o := arch/x86/boot/compressed/kaslr_64.c

deps_arch/x86/boot/compressed/kaslr_64.o := \
...
arch/x86/boot/compressed/kaslr_64.o: $(deps_arch/x86/boot/compressed/kaslr_64.o)
